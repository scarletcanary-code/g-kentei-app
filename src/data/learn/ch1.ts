  ...
  sections: [
    {
      ...
      termIds: ['narrow_ai', 'artificial_general_intelligence', 'strong_ai', 'weak_ai', 'artificial_intelligence', 'ai_level_classification'],
    },
    {
    ...
    },
    {
      ...
      termIds: ['singularity', 'intelligence', 'ai_effect'],
    },
  ],
  keyTermIds: [
